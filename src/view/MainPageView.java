...
public class MainPageView {
	...
	private JTextField postings = new JTextField();
	private JTextField searchTF = new JTextField("Look up Listings");
	...
	public MainPageView() {
		...
		/*
		 * sidePanel is the side panel and insidePanel is the middle part of the
		 * side panel
		 */
		...
		/*
		 * middlePanel is the middle panel of the frame holds the title,search
		 * text, search text field and posting
		 */
